				...
				<div class="layui-row layui-col-space10">
					<div class="layui-col-md9">
						...
						<div class="layui-form-item magt3">
							...
							<div class="layui-input-block">
								<input type="text" class="layui-input" name="title" lay-verify="required" placeholder="请输入新闻标题" id="title">
							</div>
						</div>
					</div>
...
<script type="text/javascript" src="__JS__/newsinfo/newsAdd.js"></script>
</body>
</html>