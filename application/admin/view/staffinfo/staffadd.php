				...
				<div class="layui-row layui-col-space10">
					<div class="layui-col-md9">
						...
						<div class="layui-form-item magt3">
							...
							<div class="layui-input-block">
								<input type="text" class="layui-input" name="title" lay-verify="required" placeholder="请输入内容标题" id="title">
							</div>
						</div>
					</div>
			...
			<div class="layui-card-body">
				<div class="border">
					...
					<div class="layui-form-item magt3">
						...
						<div class="layui-input-block">
							<input type="text" class="layui-input" name="viewcount" placeholder="默认为0" id="viewcount">
						</div>
					</div>
...
<script type="text/javascript" src="__JS__/staffinfo/staffAdd.js"></script>
</body>
</html>