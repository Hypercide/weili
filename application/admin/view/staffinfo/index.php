...
<form class="layui-form">
	<div class="layui-card">
		<div class="layui-card-header card-top">
			<form class="layui-form">
				...
				<div class="layui-inline">
					<a class="layui-btn layui-btn-warm addStaff_btn">添加条目</a>
				</div>
				<div class="layui-inline">
	...
	<!--操作-->
	<script type="text/html" id="staffListBar">
...
<script type="text/javascript" src="__JS__/staffinfo/staffList.js"></script>
